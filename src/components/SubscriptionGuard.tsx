...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'surat-penawaran'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug: string = 'surat-penawaran') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug: string = 'surat-penawaran'): boolean => {
    try {
